  ...
  <div id="App">
    <Layout ref="layout" style="width: 100%; height: 100%">
      ...
      <LayoutPanel
        ...
        v-if="checkShow('east')"
      >
          <div title="Свойства позиции" v-if="checkShow('prodorderposition')">
            <prod-order-position></prod-order-position>
          </div>
          <div title="Операции" v-if="checkShow('prodorderposoperations')">
            <prod-order-pos-operations></prod-order-pos-operations>
          </div>
          <div title="Отчеты работников" v-if="checkShow('prodorderposreports')">
            <prod-order-pos-reports></prod-order-pos-reports>
          </div>
          <div title="Отгрузки" v-if="checkShow('prodorderposshipments')">
